    ...
    <div className="home-dashboard">
      ...
      <div className="balance-card">
        ...
        <div className="balance-info">
          <span className="balance-label">Monad Wallet</span>
      ...
      <div className="interest-section">
        ...
        <div className="chart-container">
          <svg viewBox="0 0 300 100" className="interest-chart">
            <polyline
              fill="none"
              stroke="#2D9CDB"
              strokeWidth="2"
              points="0,80 50,70 100,75 150,60 200,50 250,40 300,35"
            />
            ...
            <polygon
              fill="url(#gradient)"
              points="0,80 50,70 100,75 150,60 200,50 250,40 300,35 300,100 0,100"
            />
          </svg>
